            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):    
                    ...
                    if save_img or view_img:
                        label = f'{names[int(cls)]} {n - count} {conf:.2f}'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='tennisPlay.mp4', help='source')  # file/folder, 0 for webcam
